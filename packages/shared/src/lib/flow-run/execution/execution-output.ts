...
export type UserResponsePauseMetadata =  BasePauseMetadata<PauseType.USER_RESPONSE> & {
  usermessage: string;
}

export type PauseMetadata = DelayPauseMetadata | WebhookPauseMetadata |UserResponsePauseMetadata
